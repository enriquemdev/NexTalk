...
import { Users2Icon, Mic, MicOff } from "lucide-react";

interface RoomClientComponentProps {
  roomId: Id<"rooms">;
}

const RoomClientComponent: React.FC<RoomClientComponentProps> = ({ roomId }) => {
  ...
  const participantUsers =
    useQuery(api.users.getMultiple, participantUserIds.length > 0 ? { userIds: participantUserIds } : "skip") || [];
